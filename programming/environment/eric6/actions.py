...
def install():
    ...
    for lang in ["cs", "de", "es", "fr", "it", "ru", "tr"]:
        pisitools.insinto("%(site-packages)s/eric6/i18n" % conf, "eric/i18n/eric6_%s.qm" % lang)
...
#    pisitools.insinto("/usr/lib/python3.3/site-packages/", "/usr/lib/python3.3/site-packages/eric5config.py")
    ...
    pisitools.remove("/usr/share/qt5/qsci/api/python/zope-2.11.2.api")
    pisitools.remove("/usr/share/qt5/qsci/api/python/zope-2.10.7.api")
    pisitools.remove("/usr/share/qt5/qsci/api/python/zope-3.3.1.api")
    pisitools.remove("/usr/share/qt5/qsci/api/ruby/Ruby-1.8.7.api")
