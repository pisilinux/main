...
def build():
    ...
    for arch in ["x86_64", "i686"]:
		if arch == "x86_64":
			...
			shelltools.export("LDFLAGS", " -fuse-ld=lld -L/usr/lib -ldl -lpthread")
			libsuffix = " "
		if arch == "i686":
...
def install():
	...
	#shelltools.copy("%s/libcxx/CREDITS.TXT" %get.workDIR(), "%s/usr/share/doc" %get.installDIR())
	#shelltools.copy("%s/libcxx/LICENCE.TXT" %get.workDIR(), "%s/usr/share/doc" %get.installDIR())
	#shelltools.copy("%s/libcxx/NOTES.TXT" %get.workDIR(), "%s/usr/share/doc" %get.installDIR())
	#shelltools.copy("%s/libcxx/TODO.TXT" %get.workDIR(), "%s/usr/share/doc" %get.installDIR())
