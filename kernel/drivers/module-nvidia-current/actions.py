...
#        pisitools.dosym("libGL.so.1.7.0", "%s/libGL.so.1.2.0" % nvlibdir)
    ...
    # CUDA
        ...
        pisitools.dolib("libnvidia-egl-wayland.so.1.1.17", libdir)
        pisitools.dosym("libnvidia-egl-wayland.so.1.1.17", "%s/libnvidia-egl-wayland.so.1" % libdir)
        pisitools.dosym("libnvidia-egl-wayland.so.1.1.17", "%s/libnvidia-egl-wayland.so" % libdir)
